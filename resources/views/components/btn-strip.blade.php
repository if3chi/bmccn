<a
    {{ $attributes->merge(['class' => 'block relative w-full mt-4 px-10 py-2 font-medium text-white transition duration-300 bg-green-400 rounded-md hover:bg-green-500 ease']) }}>
    ...
    <span class="relative font-semibold">{{ $slot }}</span>
</a>
